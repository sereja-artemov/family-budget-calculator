      ...
      <div className={s.contentWrapper}>
        ...
        <div className={s.textBlock}>
          <div className={s.textBlock__note}>
            <h3>Пример</h3>
            <p className={s.textBlock__paragraph}>
              Муж зарабатывает 50 000 рублей, а жена – 25 000 рублей. Каждый ежемесячно вкладывает в
              формирование общего котла по 30% от своего дохода. Жена – 7 500 рублей, муж – 15 000 рублей.
